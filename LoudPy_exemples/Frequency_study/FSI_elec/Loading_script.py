...
# ── Paths ──────────────────────────────────────────────────────────────────────
results_dir = Path("LoudPy_exemples/Frequency_study/FSI_elec/Results/Files")
out_dir     = Path("LoudPy_exemples/Frequency_study/FSI_elec/Results/Figures")
...
for _fpath, r, snap in all_snapshots(files):
    ...
    I_sweep.append(snap.meta.get("I_coil"))
...
fig = plot_spl_sweep_multi(
    ...
    U_drive=1.0, I_coil=I_sweep,     # -> plots |Z| = |U/I| on twin axis
)
